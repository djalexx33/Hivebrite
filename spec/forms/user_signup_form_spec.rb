...
RSpec.describe UserSignupForm, type: :model do
  describe 'validations' do
    ...
    let(:user_signup_form) { UserSignupForm.new(1) }
    context 'user adds custom attributes' do
      it 'succeeds if the custom attribute is saved' do
        expect(user_signup_form).to be_valid
      end
    end
  end
end
